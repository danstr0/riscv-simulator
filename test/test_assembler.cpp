 ...
 * @code
 *   1 (line  60) : Parsing
 *   2 (line  99) : RV32I encoding
 *   3 (line 430) : RV32I pseudo-instructions
 *   4 (line 467) : Labels
 *   5 (line 528) : M extension
 *   6 (line 574) : A extension
 *   7 (line 644) : V extension
 *   8 (line 842) : CSR and system instructions
 *   9 (line 896) : CPU integration
 *  10 (line 992) : Misc. edge cases
 * @endcode
 */
...
static u32 run_asm(const char* source, reg_idx_t result_reg = 1)
{
    Assembler as;
...
{
    // Programs can contain lines of whitespace
    const char* src =
    R"(
        j skip
        addi x1, x0, 99  # should be skipped
